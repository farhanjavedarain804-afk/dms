...
function ClientsHistoryPage() {
  ...
  return (
    <AppLayout>
      <PageHeader title="Clients History" description="Read-only history of all clients with their deal stage and invoice totals." />
...
export const Route = createFileRoute("/clients-history")({
  head: () => ({ meta: [{ title: "Clients History — Devionic DMS" }] }),
  component: ClientsHistoryPage,
});
